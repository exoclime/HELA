...
from astropy_helpers.astropy_helpers.setup_helpers import (register_commands,
                                                           get_debug_option,
                                                           get_package_info)
from astropy_helpers.astropy_helpers.git_helpers import get_git_devstr
from astropy_helpers.astropy_helpers.version_helpers import generate_version_py
...
setup(name=PACKAGENAME,
      ...
      scripts=scripts,
      install_requires=[s.strip() for s in metadata.get('install_requires',
                                                        'astropy').split(',')],
      author=AUTHOR,
